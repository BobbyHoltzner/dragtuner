...
<body id="page-top">
        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">
                    <img src="/images/logo-sm.png" class="img-responsive" alt="">
                </a>
            </div>
    ...
    <header class="video" data-video="">
        <div class="overlay"></div>
        <div class="intro-content">
            <img src="/images/logo.png" class="img-responsive logo img-centered" alt="">
            <hr class="colored">
            <div class="brand-name-subtext">Drag Racing Logbook Application</div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row text-center">
                <div class="col-lg-12 wow fadeIn">
                    <h1>Logbook Software for Drag Racers</h1>
                    <p>Whether you race for fun or professionally, Dragtuner is for you.</p>
                    <hr class="colored">
                    <h3>Take a tour!</h3>
                </div>
            </div>
            <div class="row text-center content-row">
                ...
                <div class="col-md-3 col-sm-6 wow fadeIn" data-wow-delay=".4s">
                    <div class="about-content">
                        ...
                        <h3>Easy to Use</h3>
                        <p>Our user interface is user friendly, which makes it easy to add your runs as well as editing and viewing them.</p>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 wow fadeIn" data-wow-delay=".6s">
                    <div class="about-content">
                        ...
                        <h3>Responsive</h3>
                        <p>We understand that you need to do use this on your phone, so we created mobile friendly versions as well as an app.</p>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 wow fadeIn" data-wow-delay=".8s">
                    <div class="about-content">
                        <i class="fa fa-thumbs-up fa-4x"></i>
                        <h3>Built by Racers</h3>
                        <p>This was built with the racer in mind, this solves our problems and will solve yours as well.</p>
                    </div>
                </div>
            </div>
        </div>
    </section>
    <section id="pricing" class="pricing" style="background-image: url('/images/flames-bg.jpg')">
